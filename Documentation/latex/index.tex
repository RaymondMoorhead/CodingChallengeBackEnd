...
Requests a string parameter, which is the id of an existing Enrollee. Responds with true if the deletion was successful, false otherwise.\hypertarget{index_autotoc_md11}{}\doxysubsection{Add a Dependent to an Enrollee}\label{index_autotoc_md11}
